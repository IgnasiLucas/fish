...
plot(seq(from=10, to=70, by=5), pe.prop[1,], type="l", xlab="Maximum Ns", ylab="Proportion of reads",
   main="Non-merged reads", cex.main=2, cex.lab=2, cex.axis=2, lwd=2)
for (i in c(2:14,16:24)) {
   lines(seq(from=10, to=70, by=5), pe.prop[i,])
}

plot(seq(from=10, to=70, by=5), se.prop[1,], type="l", xlab="Maximum Ns", ylab="Proportion of reads",
